...
def main() -> int:
    ...
    parser.add_argument("--provider", choices=["google", "openai"], default="google", help="LLM provider")
    parser.add_argument("--model", help="Model name. Defaults to gemini-2.5-flash for Google.")
